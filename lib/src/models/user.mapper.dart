...
class UserShortMapper extends ClassMapperBase<UserShort> {
  ...
  static const Field<UserShort, String> _f$ingameName = Field('ingameName', _$ingameName);
  ...
  static const Field<UserShort, int> _f$reputation = Field('reputation', _$reputation);
  ...
  static const Field<UserShort, MarketPlatform> _f$platform = Field('platform', _$platform);
  static bool _$crossplay(UserShort v) => v.crossplay;
  static const Field<UserShort, bool> _f$crossplay = Field('crossplay', _$crossplay);
  static UserStatus _$status(UserShort v) => v.status;
  static const Field<UserShort, UserStatus> _f$status = Field('status', _$status);
  static Activity _$activity(UserShort v) => v.activity;
  static const Field<UserShort, Activity> _f$activity = Field('activity', _$activity);
  static DateTime _$lastSeen(UserShort v) => v.lastSeen;
  static const Field<UserShort, DateTime> _f$lastSeen = Field('lastSeen', _$lastSeen);
...
mixin UserShortMappable {
  String toJson() {
    return UserShortMapper.ensureInitialized().encodeJson<UserShort>(this as UserShort);
  }

  Map<String, dynamic> toMap() {
    return UserShortMapper.ensureInitialized().encodeMap<UserShort>(this as UserShort);
  }
  ...
  @override
  String toString() {
    return UserShortMapper.ensureInitialized().stringifyValue(this as UserShort);
  }

  @override
  bool operator ==(Object other) {
    return UserShortMapper.ensureInitialized().equalsValue(this as UserShort, other);
  }
...
extension UserShortValueCopy<$R, $Out> on ObjectCopyWith<$R, UserShort, $Out> {
  UserShortCopyWith<$R, UserShort, $Out> get $asUserShort => $base.as((v, t, t2) => _UserShortCopyWithImpl(v, t, t2));
}

abstract class UserShortCopyWith<$R, $In extends UserShort, $Out> implements ClassCopyWith<$R, $In, $Out> {
...
class _UserShortCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, UserShort, $Out>
    implements UserShortCopyWith<$R, UserShort, $Out> {
  _UserShortCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<UserShort> $mapper = UserShortMapper.ensureInitialized();
  @override
  ActivityCopyWith<$R, Activity, Activity> get activity => $value.activity.copyWith.$chain((v) => call(activity: v));
  @override
  $R call({
    String? id,
    String? ingameName,
  ...
  @override
  UserShortCopyWith<$R2, UserShort, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class ActivityMapper extends ClassMapperBase<Activity> {
  ...
  static const Field<Activity, String> _f$details = Field('details', _$details, opt: true);
  static DateTime? _$startedAt(Activity v) => v.startedAt;
  static const Field<Activity, DateTime> _f$startedAt = Field('startedAt', _$startedAt, opt: true);

  @override
  final MappableFields<Activity> fields = const {#type: _f$type, #details: _f$details, #startedAt: _f$startedAt};
  @override
  final bool ignoreNull = true;

  static Activity _instantiate(DecodingData data) {
    return Activity(type: data.dec(_f$type), details: data.dec(_f$details), startedAt: data.dec(_f$startedAt));
  }
...
mixin ActivityMappable {
  String toJson() {
    return ActivityMapper.ensureInitialized().encodeJson<Activity>(this as Activity);
  }

  Map<String, dynamic> toMap() {
    return ActivityMapper.ensureInitialized().encodeMap<Activity>(this as Activity);
  }
  ...
  @override
  bool operator ==(Object other) {
    return ActivityMapper.ensureInitialized().equalsValue(this as Activity, other);
  }
...
extension ActivityValueCopy<$R, $Out> on ObjectCopyWith<$R, Activity, $Out> {
  ActivityCopyWith<$R, Activity, $Out> get $asActivity => $base.as((v, t, t2) => _ActivityCopyWithImpl(v, t, t2));
}

abstract class ActivityCopyWith<$R, $In extends Activity, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({String? type, String? details, DateTime? startedAt});
  ActivityCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _ActivityCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Activity, $Out>
    implements ActivityCopyWith<$R, Activity, $Out> {
  _ActivityCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<Activity> $mapper = ActivityMapper.ensureInitialized();
  @override
  $R call({String? type, Object? details = $none, Object? startedAt = $none}) => $apply(
    FieldCopyWithData({
  ...
  @override
  ActivityCopyWith<$R2, Activity, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class UserPublicMapper extends ClassMapperBase<UserPublic> {
  ...
  static const Field<UserPublic, String> _f$ingameName = Field('ingameName', _$ingameName);
  ...
  static const Field<UserPublic, int> _f$reputation = Field('reputation', _$reputation);
  ...
  static const Field<UserPublic, MarketPlatform> _f$platform = Field('platform', _$platform);
  static bool _$crossplay(UserPublic v) => v.crossplay;
  static const Field<UserPublic, bool> _f$crossplay = Field('crossplay', _$crossplay);
  static UserStatus _$status(UserPublic v) => v.status;
  static const Field<UserPublic, UserStatus> _f$status = Field('status', _$status);
  static Activity _$activity(UserPublic v) => v.activity;
  static const Field<UserPublic, Activity> _f$activity = Field('activity', _$activity);
  static DateTime _$lastSeen(UserPublic v) => v.lastSeen;
  static const Field<UserPublic, DateTime> _f$lastSeen = Field('lastSeen', _$lastSeen);
  static String? _$background(UserPublic v) => v.background;
  static const Field<UserPublic, String> _f$background = Field('background', _$background);
  ...
  static const Field<UserPublic, int> _f$masteryLevel = Field('masteryLevel', _$masteryLevel);
  static List<Achievement> _$achievementShowcase(UserPublic v) => v.achievementShowcase;
  static const Field<UserPublic, List<Achievement>> _f$achievementShowcase = Field(
    'achievementShowcase',
    _$achievementShowcase,
  );
  static bool? _$isBanned(UserPublic v) => v.isBanned;
  static const Field<UserPublic, bool> _f$isBanned = Field('isBanned', _$isBanned, key: r'banned');
  static DateTime? _$banUntil(UserPublic v) => v.banUntil;
  static const Field<UserPublic, DateTime> _f$banUntil = Field('banUntil', _$banUntil);
  static bool? _$wasWarned(UserPublic v) => v.wasWarned;
  static const Field<UserPublic, bool> _f$wasWarned = Field('wasWarned', _$wasWarned, key: r'warned');
  static String? _$warnMessage(UserPublic v) => v.warnMessage;
  static const Field<UserPublic, String> _f$warnMessage = Field('warnMessage', _$warnMessage);
  static String? _$banMessage(UserPublic v) => v.banMessage;
  static const Field<UserPublic, String> _f$banMessage = Field('banMessage', _$banMessage);
...
mixin UserPublicMappable {
  String toJson() {
    return UserPublicMapper.ensureInitialized().encodeJson<UserPublic>(this as UserPublic);
  }

  Map<String, dynamic> toMap() {
    return UserPublicMapper.ensureInitialized().encodeMap<UserPublic>(this as UserPublic);
  }
  ...
  @override
  String toString() {
    return UserPublicMapper.ensureInitialized().stringifyValue(this as UserPublic);
  }

  @override
  bool operator ==(Object other) {
    return UserPublicMapper.ensureInitialized().equalsValue(this as UserPublic, other);
  }
...
extension UserPublicValueCopy<$R, $Out> on ObjectCopyWith<$R, UserPublic, $Out> {
  UserPublicCopyWith<$R, UserPublic, $Out> get $asUserPublic =>
      $base.as((v, t, t2) => _UserPublicCopyWithImpl(v, t, t2));
}

abstract class UserPublicCopyWith<$R, $In extends UserPublic, $Out> implements ClassCopyWith<$R, $In, $Out> {
  ActivityCopyWith<$R, Activity, Activity> get activity;
  ListCopyWith<$R, Achievement, AchievementCopyWith<$R, Achievement, Achievement>> get achievementShowcase;
  $R call({
    String? id,
    String? ingameName,
    String? avatar,
...
class _UserPublicCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, UserPublic, $Out>
    implements UserPublicCopyWith<$R, UserPublic, $Out> {
  _UserPublicCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<UserPublic> $mapper = UserPublicMapper.ensureInitialized();
  @override
  ActivityCopyWith<$R, Activity, Activity> get activity => $value.activity.copyWith.$chain((v) => call(activity: v));
  @override
  ListCopyWith<$R, Achievement, AchievementCopyWith<$R, Achievement, Achievement>> get achievementShowcase =>
      ListCopyWith($value.achievementShowcase, (v, t) => v.copyWith.$chain(t), (v) => call(achievementShowcase: v));
  @override
  $R call({
    String? id,
    String? ingameName,
    ...
    FieldCopyWithData({
      ...
      if (achievementShowcase != null) #achievementShowcase: achievementShowcase,
  ...
  UserPublic $make(CopyWithData data) => UserPublic(
    ...
    achievementShowcase: data.get(#achievementShowcase, or: $value.achievementShowcase),
  ...
  @override
  UserPublicCopyWith<$R2, UserPublic, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class AchievementMapper extends ClassMapperBase<Achievement> {
  ...
  static const Field<Achievement, AchievementI18n> _f$i18n = Field('i18n', _$i18n);
...
mixin AchievementMappable {
  String toJson() {
    return AchievementMapper.ensureInitialized().encodeJson<Achievement>(this as Achievement);
  }

  Map<String, dynamic> toMap() {
    return AchievementMapper.ensureInitialized().encodeMap<Achievement>(this as Achievement);
  }
  ...
  @override
  String toString() {
    return AchievementMapper.ensureInitialized().stringifyValue(this as Achievement);
  }

  @override
  bool operator ==(Object other) {
    return AchievementMapper.ensureInitialized().equalsValue(this as Achievement, other);
  }
...
extension AchievementValueCopy<$R, $Out> on ObjectCopyWith<$R, Achievement, $Out> {
  AchievementCopyWith<$R, Achievement, $Out> get $asAchievement =>
      $base.as((v, t, t2) => _AchievementCopyWithImpl(v, t, t2));
}

abstract class AchievementCopyWith<$R, $In extends Achievement, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({String? id, String? icon, String? thumb, String? type, AchievementI18n? i18n});
  AchievementCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _AchievementCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Achievement, $Out>
    implements AchievementCopyWith<$R, Achievement, $Out> {
  _AchievementCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<Achievement> $mapper = AchievementMapper.ensureInitialized();
  @override
  $R call({String? id, String? icon, String? thumb, String? type, AchievementI18n? i18n}) => $apply(
    FieldCopyWithData({
      if (id != null) #id: id,
  ...
  @override
  AchievementCopyWith<$R2, Achievement, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class AchievementI18nMapper extends RecordMapperBase<AchievementI18n> {
  ...
  static const Field<AchievementI18n, String> _f$description = Field('description', _$description);

  @override
  final MappableFields<AchievementI18n> fields = const {#name: _f$name, #description: _f$description};
...
extension AchievementI18nMappable on AchievementI18n {
  ...
  AchievementI18nCopyWith<AchievementI18n> get copyWith => _AchievementI18nCopyWithImpl(this, $identity, $identity);
}

extension AchievementI18nValueCopy<$R> on ObjectCopyWith<$R, AchievementI18n, AchievementI18n> {
  AchievementI18nCopyWith<$R> get $asAchievementI18n => $base.as((v, t, t2) => _AchievementI18nCopyWithImpl(v, t, t2));
}

abstract class AchievementI18nCopyWith<$R> implements RecordCopyWith<$R, AchievementI18n> {
  $R call({String? name, String? description});
  AchievementI18nCopyWith<$R2> $chain<$R2>(Then<AchievementI18n, $R2> t);
}

class _AchievementI18nCopyWithImpl<$R> extends RecordCopyWithBase<$R, AchievementI18n>
    implements AchievementI18nCopyWith<$R> {
  _AchievementI18nCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final RecordMapperBase<AchievementI18n> $mapper = AchievementI18nMapper.ensureInitialized();
  @override
  $R call({String? name, String? description}) =>
      $apply(FieldCopyWithData({if (name != null) #name: name, if (description != null) #description: description}));
  @override
...
class UserPrivateMapper extends ClassMapperBase<UserPrivate> {
  ...
  static const Field<UserPrivate, String> _f$ingameName = Field('ingameName', _$ingameName);
  ...
  static const Field<UserPrivate, int> _f$reputation = Field('reputation', _$reputation);
  ...
  static const Field<UserPrivate, MarketPlatform> _f$platform = Field('platform', _$platform);
  static bool _$crossplay(UserPrivate v) => v.crossplay;
  static const Field<UserPrivate, bool> _f$crossplay = Field('crossplay', _$crossplay);
  static UserStatus _$status(UserPrivate v) => v.status;
  static const Field<UserPrivate, UserStatus> _f$status = Field('status', _$status);
  static Activity _$activity(UserPrivate v) => v.activity;
  static const Field<UserPrivate, Activity> _f$activity = Field(
    'activity',
    _$activity,
    opt: true,
    def: const Activity(type: ''),
  );
  static DateTime _$lastSeen(UserPrivate v) => v.lastSeen;
  static const Field<UserPrivate, DateTime> _f$lastSeen = Field('lastSeen', _$lastSeen);
  ...
  static const Field<UserPrivate, String> _f$background = Field('background', _$background, opt: true);
  static String? _$about(UserPrivate v) => v.about;
  static const Field<UserPrivate, String> _f$about = Field('about', _$about, opt: true);
  static String? _$aboutRaw(UserPrivate v) => v.aboutRaw;
  static const Field<UserPrivate, String> _f$aboutRaw = Field('aboutRaw', _$aboutRaw, opt: true);
  static int _$masteryRank(UserPrivate v) => v.masteryRank;
  static const Field<UserPrivate, int> _f$masteryRank = Field('masteryRank', _$masteryRank);
  ...
  static Achievement _$achievementShowcase(UserPrivate v) => v.achievementShowcase;
  static const Field<UserPrivate, Achievement> _f$achievementShowcase = Field(
    'achievementShowcase',
    _$achievementShowcase,
  );
  static bool _$verification(UserPrivate v) => v.verification;
  static const Field<UserPrivate, bool> _f$verification = Field('verification', _$verification);
  static String _$checkCode(UserPrivate v) => v.checkCode;
  static const Field<UserPrivate, String> _f$checkCode = Field('checkCode', _$checkCode);
  static SubscriptionTier _$tier(UserPrivate v) => v.tier;
  static const Field<UserPrivate, SubscriptionTier> _f$tier = Field('tier', _$tier);
  static bool _$isSubscribed(UserPrivate v) => v.isSubscribed;
  static const Field<UserPrivate, bool> _f$isSubscribed = Field('isSubscribed', _$isSubscribed, key: r'subscription');
  static bool? _$wasWarned(UserPrivate v) => v.wasWarned;
  static const Field<UserPrivate, bool> _f$wasWarned = Field('wasWarned', _$wasWarned, key: r'warned', opt: true);
  static String? _$warnMessage(UserPrivate v) => v.warnMessage;
  static const Field<UserPrivate, String> _f$warnMessage = Field('warnMessage', _$warnMessage, opt: true);
  static bool? _$isBanned(UserPrivate v) => v.isBanned;
  static const Field<UserPrivate, bool> _f$isBanned = Field('isBanned', _$isBanned, key: r'banned', opt: true);
  static String? _$banMessage(UserPrivate v) => v.banMessage;
  static const Field<UserPrivate, String> _f$banMessage = Field('banMessage', _$banMessage, opt: true);
  static int _$reviewsLeft(UserPrivate v) => v.reviewsLeft;
  static const Field<UserPrivate, int> _f$reviewsLeft = Field('reviewsLeft', _$reviewsLeft);
  static int _$unreadMessages(UserPrivate v) => v.unreadMessages;
  static const Field<UserPrivate, int> _f$unreadMessages = Field('unreadMessages', _$unreadMessages);
  static List<String> _$ignoreList(UserPrivate v) => v.ignoreList;
  static const Field<UserPrivate, List<String>> _f$ignoreList = Field('ignoreList', _$ignoreList);
  static bool? _$deleteInProgress(UserPrivate v) => v.deleteInProgress;
  static const Field<UserPrivate, bool> _f$deleteInProgress = Field('deleteInProgress', _$deleteInProgress, opt: true);
  static String? _$deleteAt(UserPrivate v) => v.deleteAt;
  static const Field<UserPrivate, String> _f$deleteAt = Field('deleteAt', _$deleteAt, opt: true);
  static LinkedAccounts _$linkedAccounts(UserPrivate v) => v.linkedAccounts;
  static const Field<UserPrivate, LinkedAccounts> _f$linkedAccounts = Field(
    'linkedAccounts',
    _$linkedAccounts,
    key: r'linked_accounts',
  );
  static bool _$hasEmail(UserPrivate v) => v.hasEmail;
  static const Field<UserPrivate, bool> _f$hasEmail = Field('hasEmail', _$hasEmail);
  static int _$writtenReviews(UserPrivate v) => v.writtenReviews;
  static const Field<UserPrivate, int> _f$writtenReviews = Field(
    'writtenReviews',
    _$writtenReviews,
    key: r'written_reviews',
  );
...
mixin UserPrivateMappable {
  String toJson() {
    return UserPrivateMapper.ensureInitialized().encodeJson<UserPrivate>(this as UserPrivate);
  }

  Map<String, dynamic> toMap() {
    return UserPrivateMapper.ensureInitialized().encodeMap<UserPrivate>(this as UserPrivate);
  }
  ...
  @override
  String toString() {
    return UserPrivateMapper.ensureInitialized().stringifyValue(this as UserPrivate);
  }

  @override
  bool operator ==(Object other) {
    return UserPrivateMapper.ensureInitialized().equalsValue(this as UserPrivate, other);
  }
...
extension UserPrivateValueCopy<$R, $Out> on ObjectCopyWith<$R, UserPrivate, $Out> {
  UserPrivateCopyWith<$R, UserPrivate, $Out> get $asUserPrivate =>
      $base.as((v, t, t2) => _UserPrivateCopyWithImpl(v, t, t2));
}

abstract class UserPrivateCopyWith<$R, $In extends UserPrivate, $Out> implements ClassCopyWith<$R, $In, $Out> {
  ActivityCopyWith<$R, Activity, Activity> get activity;
...
class _UserPrivateCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, UserPrivate, $Out>
    implements UserPrivateCopyWith<$R, UserPrivate, $Out> {
  _UserPrivateCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<UserPrivate> $mapper = UserPrivateMapper.ensureInitialized();
  @override
  ActivityCopyWith<$R, Activity, Activity> get activity => $value.activity.copyWith.$chain((v) => call(activity: v));
  @override
  AchievementCopyWith<$R, Achievement, Achievement> get achievementShowcase =>
      $value.achievementShowcase.copyWith.$chain((v) => call(achievementShowcase: v));
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get ignoreList =>
      ListCopyWith($value.ignoreList, (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(ignoreList: v));
  @override
  LinkedAccountsCopyWith<$R, LinkedAccounts, LinkedAccounts> get linkedAccounts =>
  ...
  UserPrivate $make(CopyWithData data) => UserPrivate(
    ...
    deleteInProgress: data.get(#deleteInProgress, or: $value.deleteInProgress),
  ...
  @override
  UserPrivateCopyWith<$R2, UserPrivate, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
mixin LinkedAccountsMappable {
  String toJson() {
    return LinkedAccountsMapper.ensureInitialized().encodeJson<LinkedAccounts>(this as LinkedAccounts);
  }

  Map<String, dynamic> toMap() {
    return LinkedAccountsMapper.ensureInitialized().encodeMap<LinkedAccounts>(this as LinkedAccounts);
  }

  LinkedAccountsCopyWith<LinkedAccounts, LinkedAccounts, LinkedAccounts> get copyWith =>
      _LinkedAccountsCopyWithImpl(this as LinkedAccounts, $identity, $identity);
  @override
  String toString() {
    return LinkedAccountsMapper.ensureInitialized().stringifyValue(this as LinkedAccounts);
  }

  @override
  bool operator ==(Object other) {
    return LinkedAccountsMapper.ensureInitialized().equalsValue(this as LinkedAccounts, other);
  }

  @override
  int get hashCode {
    return LinkedAccountsMapper.ensureInitialized().hashValue(this as LinkedAccounts);
  }
}

extension LinkedAccountsValueCopy<$R, $Out> on ObjectCopyWith<$R, LinkedAccounts, $Out> {
  LinkedAccountsCopyWith<$R, LinkedAccounts, $Out> get $asLinkedAccounts =>
      $base.as((v, t, t2) => _LinkedAccountsCopyWithImpl(v, t, t2));
}

abstract class LinkedAccountsCopyWith<$R, $In extends LinkedAccounts, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({bool? steamProfile, bool? patreonProfile, bool? xboxProfile});
  LinkedAccountsCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _LinkedAccountsCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, LinkedAccounts, $Out>
    implements LinkedAccountsCopyWith<$R, LinkedAccounts, $Out> {
  _LinkedAccountsCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<LinkedAccounts> $mapper = LinkedAccountsMapper.ensureInitialized();
  @override
  $R call({bool? steamProfile, bool? patreonProfile, bool? xboxProfile}) => $apply(
    FieldCopyWithData({
  ...
  @override
  LinkedAccountsCopyWith<$R2, LinkedAccounts, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class PatreonProfileMapper extends ClassMapperBase<PatreonProfile> {
  ...
  static const Field<PatreonProfile, bool> _f$patreonFounder = Field(
    'patreonFounder',
    _$patreonFounder,
    key: r'patreon_founder',
  );
  static bool _$subscription(PatreonProfile v) => v.subscription;
  static const Field<PatreonProfile, bool> _f$subscription = Field('subscription', _$subscription);
  static PatreonBadge _$patreonBadge(PatreonProfile v) => v.patreonBadge;
  static const Field<PatreonProfile, PatreonBadge> _f$patreonBadge = Field(
    'patreonBadge',
    _$patreonBadge,
    key: r'patreon_badge',
  );
...
mixin PatreonProfileMappable {
  String toJson() {
    return PatreonProfileMapper.ensureInitialized().encodeJson<PatreonProfile>(this as PatreonProfile);
  }

  Map<String, dynamic> toMap() {
    return PatreonProfileMapper.ensureInitialized().encodeMap<PatreonProfile>(this as PatreonProfile);
  }

  PatreonProfileCopyWith<PatreonProfile, PatreonProfile, PatreonProfile> get copyWith =>
      _PatreonProfileCopyWithImpl(this as PatreonProfile, $identity, $identity);
  @override
  String toString() {
    return PatreonProfileMapper.ensureInitialized().stringifyValue(this as PatreonProfile);
  }

  @override
  bool operator ==(Object other) {
    return PatreonProfileMapper.ensureInitialized().equalsValue(this as PatreonProfile, other);
  }

  @override
  int get hashCode {
    return PatreonProfileMapper.ensureInitialized().hashValue(this as PatreonProfile);
  }
}

extension PatreonProfileValueCopy<$R, $Out> on ObjectCopyWith<$R, PatreonProfile, $Out> {
  PatreonProfileCopyWith<$R, PatreonProfile, $Out> get $asPatreonProfile =>
      $base.as((v, t, t2) => _PatreonProfileCopyWithImpl(v, t, t2));
}

abstract class PatreonProfileCopyWith<$R, $In extends PatreonProfile, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({bool? patreonFounder, bool? subscription, PatreonBadge? patreonBadge});
  PatreonProfileCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _PatreonProfileCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, PatreonProfile, $Out>
    implements PatreonProfileCopyWith<$R, PatreonProfile, $Out> {
  _PatreonProfileCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<PatreonProfile> $mapper = PatreonProfileMapper.ensureInitialized();
  @override
  $R call({bool? patreonFounder, bool? subscription, PatreonBadge? patreonBadge}) => $apply(
    FieldCopyWithData({
  ...
  @override
  PatreonProfileCopyWith<$R2, PatreonProfile, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
