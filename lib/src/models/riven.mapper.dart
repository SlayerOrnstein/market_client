...
mixin RivenMappable {
  ...
  RivenCopyWith<Riven, Riven, Riven> get copyWith =>
      _RivenCopyWithImpl(this as Riven, $identity, $identity);
  @override
  String toString() {
...
extension RivenValueCopy<$R, $Out> on ObjectCopyWith<$R, Riven, $Out> {
  RivenCopyWith<$R, Riven, $Out> get $asRiven =>
      $base.as((v, t, t2) => _RivenCopyWithImpl(v, t, t2));
}
...
class _RivenCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Riven, $Out>
  ...
  RivenCopyWith<$R2, Riven, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _RivenCopyWithImpl($value, $cast, t);
}
...
extension RivenI18nValueCopy<$R, $Out> on ObjectCopyWith<$R, RivenI18n, $Out> {
  RivenI18nCopyWith<$R, RivenI18n, $Out> get $asRivenI18n =>
      $base.as((v, t, t2) => _RivenI18nCopyWithImpl(v, t, t2));
}
