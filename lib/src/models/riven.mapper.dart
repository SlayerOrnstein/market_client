...
class RivenMapper extends ClassMapperBase<Riven> {
  ...
  static const Field<Riven, RivenType> _f$rivenType =
      Field('rivenType', _$rivenType);
  static double _$disposition(Riven v) => v.disposition;
  static const Field<Riven, double> _f$disposition =
      Field('disposition', _$disposition);
  static int _$reqMasteryRank(Riven v) => v.reqMasteryRank;
  static const Field<Riven, int> _f$reqMasteryRank =
      Field('reqMasteryRank', _$reqMasteryRank);
  static Map<String, RivenI18n> _$i18n(Riven v) => v.i18n;
  static const Field<Riven, Map<String, RivenI18n>> _f$i18n =
      Field('i18n', _$i18n);
...
mixin RivenMappable {
  ...
  RivenCopyWith<Riven, Riven, Riven> get copyWith =>
      _RivenCopyWithImpl<Riven, Riven>(this as Riven, $identity, $identity);
  @override
  String toString() {
...
extension RivenValueCopy<$R, $Out> on ObjectCopyWith<$R, Riven, $Out> {
  RivenCopyWith<$R, Riven, $Out> get $asRiven =>
      $base.as((v, t, t2) => _RivenCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class RivenCopyWith<$R, $In extends Riven, $Out>
    implements ClassCopyWith<$R, $In, $Out> {
  MapCopyWith<$R, String, RivenI18n,
      RivenI18nCopyWith<$R, RivenI18n, RivenI18n>> get i18n;
  $R call(
      {String? id,
      String? slug,
      String? gameRef,
...
class _RivenCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Riven, $Out>
  ...
  @override
  MapCopyWith<$R, String, RivenI18n,
          RivenI18nCopyWith<$R, RivenI18n, RivenI18n>>
  ...
  @override
  RivenCopyWith<$R2, Riven, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _RivenCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
...
class RivenI18nMapper extends ClassMapperBase<RivenI18n> {
  ...
  static const Field<RivenI18n, String> _f$itemName =
      Field('itemName', _$itemName);
  static String? _$wikiLink(RivenI18n v) => v.wikiLink;
  static const Field<RivenI18n, String> _f$wikiLink =
...
mixin RivenI18nMappable {
  String toJson() {
    return RivenI18nMapper.ensureInitialized()
        .encodeJson<RivenI18n>(this as RivenI18n);
  }

  Map<String, dynamic> toMap() {
    return RivenI18nMapper.ensureInitialized()
        .encodeMap<RivenI18n>(this as RivenI18n);
  }

  RivenI18nCopyWith<RivenI18n, RivenI18n, RivenI18n> get copyWith =>
      _RivenI18nCopyWithImpl<RivenI18n, RivenI18n>(
          this as RivenI18n, $identity, $identity);
  @override
  String toString() {
    return RivenI18nMapper.ensureInitialized()
        .stringifyValue(this as RivenI18n);
  }

  @override
  bool operator ==(Object other) {
    return RivenI18nMapper.ensureInitialized()
        .equalsValue(this as RivenI18n, other);
  }
...
extension RivenI18nValueCopy<$R, $Out> on ObjectCopyWith<$R, RivenI18n, $Out> {
  RivenI18nCopyWith<$R, RivenI18n, $Out> get $asRivenI18n =>
      $base.as((v, t, t2) => _RivenI18nCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class RivenI18nCopyWith<$R, $In extends RivenI18n, $Out>
    implements ClassCopyWith<$R, $In, $Out> {
  $R call({String? itemName, String? wikiLink, String? icon, String? thumb});
  RivenI18nCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _RivenI18nCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, RivenI18n, $Out>
    implements RivenI18nCopyWith<$R, RivenI18n, $Out> {
  _RivenI18nCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<RivenI18n> $mapper =
      RivenI18nMapper.ensureInitialized();
  @override
  $R call(
          {String? itemName,
  ...
  @override
  RivenI18nCopyWith<$R2, RivenI18n, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _RivenI18nCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
