...
ItemFull _$ItemFullFromJson(Map<String, dynamic> json) => ItemFull(
      ...
      modMaxRank: (json['mod_max_rank'] as num?)?.toInt(),
      subtypes: (json['subtypes'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      tags: (json['tags'] as List<dynamic>).map((e) => e as String).toList(),
      cyanStars: (json['cyan_stars'] as num?)?.toInt(),
      amberStars: (json['amber_stars'] as num?)?.toInt(),
      ducats: (json['ducats'] as num?)?.toInt(),
      quantityForSet: (json['quantity_for_set'] as num?)?.toInt(),
      ...
      tradingTax: (json['trading_tax'] as num?)?.toInt(),
