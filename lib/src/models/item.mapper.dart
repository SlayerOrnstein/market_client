...
class ItemI18nMapper extends ClassMapperBase<ItemI18n> {
  ...
  static const Field<ItemI18n, String> _f$description = Field('description', _$description, opt: true);
  static String? _$wikiLink(ItemI18n v) => v.wikiLink;
  static const Field<ItemI18n, String> _f$wikiLink = Field('wikiLink', _$wikiLink, opt: true);
  ...
  static const Field<ItemI18n, String> _f$subIcon = Field('subIcon', _$subIcon, opt: true);
...
mixin ItemI18nMappable {
  String toJson() {
    return ItemI18nMapper.ensureInitialized().encodeJson<ItemI18n>(this as ItemI18n);
  }

  Map<String, dynamic> toMap() {
    return ItemI18nMapper.ensureInitialized().encodeMap<ItemI18n>(this as ItemI18n);
  }
  ...
  bool operator ==(Object other) {
    return ItemI18nMapper.ensureInitialized().equalsValue(this as ItemI18n, other);
  }
...
extension ItemI18nValueCopy<$R, $Out> on ObjectCopyWith<$R, ItemI18n, $Out> {
  ItemI18nCopyWith<$R, ItemI18n, $Out> get $asItemI18n => $base.as((v, t, t2) => _ItemI18nCopyWithImpl(v, t, t2));
}

abstract class ItemI18nCopyWith<$R, $In extends ItemI18n, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({String? name, String? description, String? wikiLink, String? icon, String? thumb, String? subIcon});
  ItemI18nCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _ItemI18nCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, ItemI18n, $Out>
    implements ItemI18nCopyWith<$R, ItemI18n, $Out> {
  _ItemI18nCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<ItemI18n> $mapper = ItemI18nMapper.ensureInitialized();
  @override
  $R call({
    String? name,
  ...
  @override
  ItemI18nCopyWith<$R2, ItemI18n, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class ItemShortMapper extends ClassMapperBase<ItemShort> {
  ...
  static const Field<ItemShort, String> _f$gameRef = Field('gameRef', _$gameRef);
  static Map<String, ItemI18n> _$i18n(ItemShort v) => v.i18n;
  static const Field<ItemShort, Map<String, ItemI18n>> _f$i18n = Field('i18n', _$i18n);
  ...
  static const Field<ItemShort, int> _f$maxCharges = Field('maxCharges', _$maxCharges);
  ...
  static const Field<ItemShort, bool> _f$bulkTradable = Field('bulkTradable', _$bulkTradable);
  ...
  static const Field<ItemShort, int> _f$maxAmberStars = Field('maxAmberStars', _$maxAmberStars);
  static int? _$maxCyanStars(ItemShort v) => v.maxCyanStars;
  static const Field<ItemShort, int> _f$maxCyanStars = Field('maxCyanStars', _$maxCyanStars);
  static int? _$baseEndo(ItemShort v) => v.baseEndo;
  static const Field<ItemShort, int> _f$baseEndo = Field('baseEndo', _$baseEndo);
  static int? _$endoMultiplier(ItemShort v) => v.endoMultiplier;
  static const Field<ItemShort, int> _f$endoMultiplier = Field('endoMultiplier', _$endoMultiplier);
  static List<String>? _$subtypes(ItemShort v) => v.subtypes;
  static const Field<ItemShort, List<String>> _f$subtypes = Field('subtypes', _$subtypes);
...
mixin ItemShortMappable {
  String toJson() {
    return ItemShortMapper.ensureInitialized().encodeJson<ItemShort>(this as ItemShort);
  }

  Map<String, dynamic> toMap() {
    return ItemShortMapper.ensureInitialized().encodeMap<ItemShort>(this as ItemShort);
  }
  ...
  @override
  String toString() {
    return ItemShortMapper.ensureInitialized().stringifyValue(this as ItemShort);
  }

  @override
  bool operator ==(Object other) {
    return ItemShortMapper.ensureInitialized().equalsValue(this as ItemShort, other);
  }
...
extension ItemShortValueCopy<$R, $Out> on ObjectCopyWith<$R, ItemShort, $Out> {
  ItemShortCopyWith<$R, ItemShort, $Out> get $asItemShort => $base.as((v, t, t2) => _ItemShortCopyWithImpl(v, t, t2));
}

abstract class ItemShortCopyWith<$R, $In extends ItemShort, $Out> implements ClassCopyWith<$R, $In, $Out> {
  MapCopyWith<$R, String, ItemI18n, ItemI18nCopyWith<$R, ItemI18n, ItemI18n>> get i18n;
...
class _ItemShortCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, ItemShort, $Out>
    implements ItemShortCopyWith<$R, ItemShort, $Out> {
  _ItemShortCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<ItemShort> $mapper = ItemShortMapper.ensureInitialized();
  @override
  MapCopyWith<$R, String, ItemI18n, ItemI18nCopyWith<$R, ItemI18n, ItemI18n>> get i18n =>
  ...
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>>? get subtypes =>
      $value.subtypes != null
          ? ListCopyWith($value.subtypes!, (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(subtypes: v))
          : null;
  @override
  $R call({
    String? id,
  ...
  @override
  ItemShortCopyWith<$R2, ItemShort, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class ItemFullMapper extends ClassMapperBase<ItemFull> {
  ...
  static const Field<ItemFull, Map<String, ItemI18n>> _f$i18n = Field('i18n', _$i18n);
  ...
  static const Field<ItemFull, int> _f$maxCharges = Field('maxCharges', _$maxCharges);
  ...
  static const Field<ItemFull, bool> _f$bulkTradable = Field('bulkTradable', _$bulkTradable);
  ...
  static const Field<ItemFull, int> _f$maxAmberStars = Field('maxAmberStars', _$maxAmberStars);
  static int? _$maxCyanStars(ItemFull v) => v.maxCyanStars;
  static const Field<ItemFull, int> _f$maxCyanStars = Field('maxCyanStars', _$maxCyanStars);
  ...
  static const Field<ItemFull, int> _f$endoMultiplier = Field('endoMultiplier', _$endoMultiplier);
  static List<String>? _$subtypes(ItemFull v) => v.subtypes;
  static const Field<ItemFull, List<String>> _f$subtypes = Field('subtypes', _$subtypes);
  static bool _$tradable(ItemFull v) => v.tradable;
  static const Field<ItemFull, bool> _f$tradable = Field('tradable', _$tradable);
  ...
  static const Field<ItemFull, List<String>> _f$setParts = Field('setParts', _$setParts);
  static int _$quantityInSet(ItemFull v) => v.quantityInSet;
  static const Field<ItemFull, int> _f$quantityInSet = Field('quantityInSet', _$quantityInSet);
  ...
  static const Field<ItemFull, int> _f$reqMasteryRank = Field('reqMasteryRank', _$reqMasteryRank);
  static int? _$tradingTax(ItemFull v) => v.tradingTax;
  static const Field<ItemFull, int> _f$tradingTax = Field('tradingTax', _$tradingTax);
...
mixin ItemFullMappable {
  String toJson() {
    return ItemFullMapper.ensureInitialized().encodeJson<ItemFull>(this as ItemFull);
  }

  Map<String, dynamic> toMap() {
    return ItemFullMapper.ensureInitialized().encodeMap<ItemFull>(this as ItemFull);
  }
  ...
  @override
  bool operator ==(Object other) {
    return ItemFullMapper.ensureInitialized().equalsValue(this as ItemFull, other);
  }
...
extension ItemFullValueCopy<$R, $Out> on ObjectCopyWith<$R, ItemFull, $Out> {
  ItemFullCopyWith<$R, ItemFull, $Out> get $asItemFull => $base.as((v, t, t2) => _ItemFullCopyWithImpl(v, t, t2));
}

abstract class ItemFullCopyWith<$R, $In extends ItemFull, $Out> implements ClassCopyWith<$R, $In, $Out> {
  MapCopyWith<$R, String, ItemI18n, ItemI18nCopyWith<$R, ItemI18n, ItemI18n>> get i18n;
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get tags;
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>>? get subtypes;
...
class _ItemFullCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, ItemFull, $Out>
    implements ItemFullCopyWith<$R, ItemFull, $Out> {
  _ItemFullCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<ItemFull> $mapper = ItemFullMapper.ensureInitialized();
  @override
  MapCopyWith<$R, String, ItemI18n, ItemI18nCopyWith<$R, ItemI18n, ItemI18n>> get i18n =>
      MapCopyWith($value.i18n, (v, t) => v.copyWith.$chain(t), (v) => call(i18n: v));
  @override
  ...
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get setParts =>
      ListCopyWith($value.setParts, (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(setParts: v));
  @override
  $R call({
    String? id,
    String? slug,
  ...
  @override
  ItemFullCopyWith<$R2, ItemFull, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
