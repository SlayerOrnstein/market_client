...
class OrderMapper extends ClassMapperBase<Order> {
  ...
  static const Field<Order, int> _f$amberStars = Field('amberStars', _$amberStars);
  ...
  static const Field<Order, DateTime> _f$creationAt = Field('creationAt', _$creationAt);
  static DateTime _$updateAt(Order v) => v.updateAt;
  static const Field<Order, DateTime> _f$updateAt = Field('updateAt', _$updateAt);
...
mixin OrderMappable {
  ...
  OrderCopyWith<Order, Order, Order> get copyWith => _OrderCopyWithImpl(this as Order, $identity, $identity);
  @override
  String toString() {
...
extension OrderValueCopy<$R, $Out> on ObjectCopyWith<$R, Order, $Out> {
  OrderCopyWith<$R, Order, $Out> get $asOrder => $base.as((v, t, t2) => _OrderCopyWithImpl(v, t, t2));
}

abstract class OrderCopyWith<$R, $In extends Order, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({
    String? id,
    OrderType? type,
    int? platinum,
...
class _OrderCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Order, $Out>
  ...
  @override
  OrderCopyWith<$R2, Order, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) => _OrderCopyWithImpl($value, $cast, t);
}
...
class OrderWithUserMapper extends SubClassMapperBase<OrderWithUser> {
  ...
  static const Field<OrderWithUser, int> _f$platinum = Field('platinum', _$platinum);
  static int _$quantity(OrderWithUser v) => v.quantity;
  static const Field<OrderWithUser, int> _f$quantity = Field('quantity', _$quantity);
  static int? _$perTrade(OrderWithUser v) => v.perTrade;
  static const Field<OrderWithUser, int> _f$perTrade = Field('perTrade', _$perTrade);
  ...
  static const Field<OrderWithUser, int> _f$charges = Field('charges', _$charges);
  static String? _$subtype(OrderWithUser v) => v.subtype;
  static const Field<OrderWithUser, String> _f$subtype = Field('subtype', _$subtype);
  static int _$amberStars(OrderWithUser v) => v.amberStars;
  static const Field<OrderWithUser, int> _f$amberStars = Field('amberStars', _$amberStars);
  static int _$cyanStars(OrderWithUser v) => v.cyanStars;
  static const Field<OrderWithUser, int> _f$cyanStars = Field('cyanStars', _$cyanStars);
  static bool _$visible(OrderWithUser v) => v.visible;
  static const Field<OrderWithUser, bool> _f$visible = Field('visible', _$visible);
  static DateTime _$creationAt(OrderWithUser v) => v.creationAt;
  static const Field<OrderWithUser, DateTime> _f$creationAt = Field('creationAt', _$creationAt);
  static DateTime _$updateAt(OrderWithUser v) => v.updateAt;
  static const Field<OrderWithUser, DateTime> _f$updateAt = Field('updateAt', _$updateAt);
  static String? _$itemId(OrderWithUser v) => v.itemId;
  static const Field<OrderWithUser, String> _f$itemId = Field('itemId', _$itemId);
...
mixin OrderWithUserMappable {
  String toJson() {
    return OrderWithUserMapper.ensureInitialized().encodeJson<OrderWithUser>(this as OrderWithUser);
  }

  Map<String, dynamic> toMap() {
    return OrderWithUserMapper.ensureInitialized().encodeMap<OrderWithUser>(this as OrderWithUser);
  }

  OrderWithUserCopyWith<OrderWithUser, OrderWithUser, OrderWithUser> get copyWith =>
      _OrderWithUserCopyWithImpl(this as OrderWithUser, $identity, $identity);
  @override
  String toString() {
    return OrderWithUserMapper.ensureInitialized().stringifyValue(this as OrderWithUser);
  }

  @override
  bool operator ==(Object other) {
    return OrderWithUserMapper.ensureInitialized().equalsValue(this as OrderWithUser, other);
  }

  @override
  int get hashCode {
    return OrderWithUserMapper.ensureInitialized().hashValue(this as OrderWithUser);
  }
}

extension OrderWithUserValueCopy<$R, $Out> on ObjectCopyWith<$R, OrderWithUser, $Out> {
  OrderWithUserCopyWith<$R, OrderWithUser, $Out> get $asOrderWithUser =>
      $base.as((v, t, t2) => _OrderWithUserCopyWithImpl(v, t, t2));
}

abstract class OrderWithUserCopyWith<$R, $In extends OrderWithUser, $Out> implements OrderCopyWith<$R, $In, $Out> {
...
class _OrderWithUserCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, OrderWithUser, $Out>
    implements OrderWithUserCopyWith<$R, OrderWithUser, $Out> {
  _OrderWithUserCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<OrderWithUser> $mapper = OrderWithUserMapper.ensureInitialized();
  @override
  UserShortCopyWith<$R, UserShort, UserShort> get user => $value.user.copyWith.$chain((v) => call(user: v));
  @override
  $R call({
    String? id,
    OrderType? type,
  ...
  @override
  OrderWithUserCopyWith<$R2, OrderWithUser, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
