...
class OrderMapper extends ClassMapperBase<Order> {
  ...
  static DateTime _$updatedAt(Order v) => v.updatedAt;
  static const Field<Order, DateTime> _f$updatedAt =
...
class OrderWithUserMapper extends ClassMapperBase<OrderWithUser> {
  ...
  static DateTime _$createdAt(OrderWithUser v) => v.createdAt;
  static const Field<OrderWithUser, DateTime> _f$createdAt =
      Field('createdAt', _$createdAt);
  static DateTime _$updatedAt(OrderWithUser v) => v.updatedAt;
  static const Field<OrderWithUser, DateTime> _f$updatedAt =
      Field('updatedAt', _$updatedAt);
...
mixin OrderWithUserMappable {
  ...
  OrderWithUserCopyWith<OrderWithUser, OrderWithUser, OrderWithUser>
      get copyWith => _OrderWithUserCopyWithImpl<OrderWithUser, OrderWithUser>(
...
extension OrderWithUserValueCopy<$R, $Out>
  ...
  OrderWithUserCopyWith<$R, OrderWithUser, $Out> get $asOrderWithUser =>
      $base.as((v, t, t2) => _OrderWithUserCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _OrderWithUserCopyWithImpl<$R, $Out>
  ...
  OrderWithUserCopyWith<$R2, OrderWithUser, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _OrderWithUserCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
