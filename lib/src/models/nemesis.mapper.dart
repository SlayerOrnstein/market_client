...
class NemesisI18nMapper extends ClassMapperBase<NemesisI18n> {
  ...
  static const Field<NemesisI18n, String> _f$itemName = Field('itemName', _$itemName);
  static String? _$description(NemesisI18n v) => v.description;
  static const Field<NemesisI18n, String> _f$description = Field('description', _$description);
  static String? _$wikiLink(NemesisI18n v) => v.wikiLink;
  static const Field<NemesisI18n, String> _f$wikiLink = Field('wikiLink', _$wikiLink);
...
mixin NemesisI18nMappable {
  String toJson() {
    return NemesisI18nMapper.ensureInitialized().encodeJson<NemesisI18n>(this as NemesisI18n);
  }

  Map<String, dynamic> toMap() {
    return NemesisI18nMapper.ensureInitialized().encodeMap<NemesisI18n>(this as NemesisI18n);
  }
  ...
  @override
  String toString() {
    return NemesisI18nMapper.ensureInitialized().stringifyValue(this as NemesisI18n);
  }

  @override
  bool operator ==(Object other) {
    return NemesisI18nMapper.ensureInitialized().equalsValue(this as NemesisI18n, other);
  }
...
extension NemesisI18nValueCopy<$R, $Out> on ObjectCopyWith<$R, NemesisI18n, $Out> {
  NemesisI18nCopyWith<$R, NemesisI18n, $Out> get $asNemesisI18n =>
      $base.as((v, t, t2) => _NemesisI18nCopyWithImpl(v, t, t2));
}

abstract class NemesisI18nCopyWith<$R, $In extends NemesisI18n, $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({String? itemName, String? description, String? wikiLink, String? icon, String? thumb});
  NemesisI18nCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _NemesisI18nCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, NemesisI18n, $Out>
    implements NemesisI18nCopyWith<$R, NemesisI18n, $Out> {
  _NemesisI18nCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<NemesisI18n> $mapper = NemesisI18nMapper.ensureInitialized();
  @override
  $R call({
    String? itemName,
  ...
  @override
  NemesisI18nCopyWith<$R2, NemesisI18n, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class NemesisWeaponMapper extends ClassMapperBase<NemesisWeapon> {
  ...
  static const Field<NemesisWeapon, String> _f$gameRef = Field('gameRef', _$gameRef);
  static int _$reqMasteryRank(NemesisWeapon v) => v.reqMasteryRank;
  static const Field<NemesisWeapon, int> _f$reqMasteryRank = Field('reqMasteryRank', _$reqMasteryRank);
  static Map<String, NemesisI18n> _$i18n(NemesisWeapon v) => v.i18n;
  static const Field<NemesisWeapon, Map<String, NemesisI18n>> _f$i18n = Field('i18n', _$i18n);
...
mixin NemesisWeaponMappable {
  String toJson() {
    return NemesisWeaponMapper.ensureInitialized().encodeJson<NemesisWeapon>(this as NemesisWeapon);
  }

  Map<String, dynamic> toMap() {
    return NemesisWeaponMapper.ensureInitialized().encodeMap<NemesisWeapon>(this as NemesisWeapon);
  }

  NemesisWeaponCopyWith<NemesisWeapon, NemesisWeapon, NemesisWeapon> get copyWith =>
      _NemesisWeaponCopyWithImpl(this as NemesisWeapon, $identity, $identity);
  @override
  String toString() {
    return NemesisWeaponMapper.ensureInitialized().stringifyValue(this as NemesisWeapon);
  }

  @override
  bool operator ==(Object other) {
    return NemesisWeaponMapper.ensureInitialized().equalsValue(this as NemesisWeapon, other);
  }

  @override
  int get hashCode {
    return NemesisWeaponMapper.ensureInitialized().hashValue(this as NemesisWeapon);
  }
}

extension NemesisWeaponValueCopy<$R, $Out> on ObjectCopyWith<$R, NemesisWeapon, $Out> {
  NemesisWeaponCopyWith<$R, NemesisWeapon, $Out> get $asNemesisWeapon =>
      $base.as((v, t, t2) => _NemesisWeaponCopyWithImpl(v, t, t2));
}

abstract class NemesisWeaponCopyWith<$R, $In extends NemesisWeapon, $Out> implements ClassCopyWith<$R, $In, $Out> {
  MapCopyWith<$R, String, NemesisI18n, NemesisI18nCopyWith<$R, NemesisI18n, NemesisI18n>> get i18n;
  $R call({String? id, String? slug, String? gameRef, int? reqMasteryRank, Map<String, NemesisI18n>? i18n});
  NemesisWeaponCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _NemesisWeaponCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, NemesisWeapon, $Out>
    implements NemesisWeaponCopyWith<$R, NemesisWeapon, $Out> {
  _NemesisWeaponCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<NemesisWeapon> $mapper = NemesisWeaponMapper.ensureInitialized();
  @override
  MapCopyWith<$R, String, NemesisI18n, NemesisI18nCopyWith<$R, NemesisI18n, NemesisI18n>> get i18n =>
      MapCopyWith($value.i18n, (v, t) => v.copyWith.$chain(t), (v) => call(i18n: v));
  @override
  $R call({String? id, String? slug, String? gameRef, int? reqMasteryRank, Map<String, NemesisI18n>? i18n}) => $apply(
    FieldCopyWithData({
      if (id != null) #id: id,
  ...
  @override
  NemesisWeaponCopyWith<$R2, NemesisWeapon, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class NemesisEphemeraMapper extends ClassMapperBase<NemesisEphemera> {
  ...
  static const Field<NemesisEphemera, String> _f$gameRef = Field('gameRef', _$gameRef);
  static String _$animation(NemesisEphemera v) => v.animation;
  static const Field<NemesisEphemera, String> _f$animation = Field('animation', _$animation);
  static String _$element(NemesisEphemera v) => v.element;
  static const Field<NemesisEphemera, String> _f$element = Field('element', _$element);
  static Map<String, NemesisI18n> _$i18n(NemesisEphemera v) => v.i18n;
  static const Field<NemesisEphemera, Map<String, NemesisI18n>> _f$i18n = Field('i18n', _$i18n);
...
mixin NemesisEphemeraMappable {
  String toJson() {
    return NemesisEphemeraMapper.ensureInitialized().encodeJson<NemesisEphemera>(this as NemesisEphemera);
  }

  Map<String, dynamic> toMap() {
    return NemesisEphemeraMapper.ensureInitialized().encodeMap<NemesisEphemera>(this as NemesisEphemera);
  }

  NemesisEphemeraCopyWith<NemesisEphemera, NemesisEphemera, NemesisEphemera> get copyWith =>
      _NemesisEphemeraCopyWithImpl(this as NemesisEphemera, $identity, $identity);
  @override
  String toString() {
    return NemesisEphemeraMapper.ensureInitialized().stringifyValue(this as NemesisEphemera);
  }

  @override
  bool operator ==(Object other) {
    return NemesisEphemeraMapper.ensureInitialized().equalsValue(this as NemesisEphemera, other);
  }

  @override
  int get hashCode {
    return NemesisEphemeraMapper.ensureInitialized().hashValue(this as NemesisEphemera);
  }
}

extension NemesisEphemeraValueCopy<$R, $Out> on ObjectCopyWith<$R, NemesisEphemera, $Out> {
  NemesisEphemeraCopyWith<$R, NemesisEphemera, $Out> get $asNemesisEphemera =>
      $base.as((v, t, t2) => _NemesisEphemeraCopyWithImpl(v, t, t2));
}

abstract class NemesisEphemeraCopyWith<$R, $In extends NemesisEphemera, $Out> implements ClassCopyWith<$R, $In, $Out> {
  MapCopyWith<$R, String, NemesisI18n, NemesisI18nCopyWith<$R, NemesisI18n, NemesisI18n>> get i18n;
  $R call({
    String? id,
    String? slug,
  ...
  NemesisEphemeraCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _NemesisEphemeraCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, NemesisEphemera, $Out>
    implements NemesisEphemeraCopyWith<$R, NemesisEphemera, $Out> {
  _NemesisEphemeraCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<NemesisEphemera> $mapper = NemesisEphemeraMapper.ensureInitialized();
  @override
  MapCopyWith<$R, String, NemesisI18n, NemesisI18nCopyWith<$R, NemesisI18n, NemesisI18n>> get i18n =>
      MapCopyWith($value.i18n, (v, t) => v.copyWith.$chain(t), (v) => call(i18n: v));
  @override
  ...
  @override
  NemesisEphemeraCopyWith<$R2, NemesisEphemera, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
...
class NemesisQuirkMapper extends ClassMapperBase<NemesisQuirk> {
  ...
  static const Field<NemesisQuirk, Map<String, NemesisI18n>> _f$i18n = Field('i18n', _$i18n);

  @override
  final MappableFields<NemesisQuirk> fields = const {#id: _f$id, #slug: _f$slug, #group: _f$group, #i18n: _f$i18n};
  @override
  final bool ignoreNull = true;
...
mixin NemesisQuirkMappable {
  String toJson() {
    return NemesisQuirkMapper.ensureInitialized().encodeJson<NemesisQuirk>(this as NemesisQuirk);
  }

  Map<String, dynamic> toMap() {
    return NemesisQuirkMapper.ensureInitialized().encodeMap<NemesisQuirk>(this as NemesisQuirk);
  }
  ...
  @override
  String toString() {
    return NemesisQuirkMapper.ensureInitialized().stringifyValue(this as NemesisQuirk);
  }

  @override
  bool operator ==(Object other) {
    return NemesisQuirkMapper.ensureInitialized().equalsValue(this as NemesisQuirk, other);
  }

  @override
  int get hashCode {
    return NemesisQuirkMapper.ensureInitialized().hashValue(this as NemesisQuirk);
  }
}

extension NemesisQuirkValueCopy<$R, $Out> on ObjectCopyWith<$R, NemesisQuirk, $Out> {
  NemesisQuirkCopyWith<$R, NemesisQuirk, $Out> get $asNemesisQuirk =>
      $base.as((v, t, t2) => _NemesisQuirkCopyWithImpl(v, t, t2));
}

abstract class NemesisQuirkCopyWith<$R, $In extends NemesisQuirk, $Out> implements ClassCopyWith<$R, $In, $Out> {
  MapCopyWith<$R, String, NemesisI18n, NemesisI18nCopyWith<$R, NemesisI18n, NemesisI18n>> get i18n;
  $R call({String? id, String? slug, String? group, Map<String, NemesisI18n>? i18n});
  NemesisQuirkCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _NemesisQuirkCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, NemesisQuirk, $Out>
    implements NemesisQuirkCopyWith<$R, NemesisQuirk, $Out> {
  _NemesisQuirkCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<NemesisQuirk> $mapper = NemesisQuirkMapper.ensureInitialized();
  @override
  MapCopyWith<$R, String, NemesisI18n, NemesisI18nCopyWith<$R, NemesisI18n, NemesisI18n>> get i18n =>
      MapCopyWith($value.i18n, (v, t) => v.copyWith.$chain(t), (v) => call(i18n: v));
  @override
  $R call({String? id, String? slug, Object? group = $none, Map<String, NemesisI18n>? i18n}) => $apply(
    FieldCopyWithData({
      if (id != null) #id: id,
      if (slug != null) #slug: slug,
  ...
  @override
  NemesisQuirkCopyWith<$R2, NemesisQuirk, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
